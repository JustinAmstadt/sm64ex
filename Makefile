...
# Hi, I'm a PC
SRC_DIRS := src src/engine src/game src/capture src/audio src/menu src/buffers actors levels bin data assets src/pc src/pc/gfx src/pc/audio src/pc/controller src/pc/fs src/pc/fs/packtypes
ASM_DIRS :=
...
BACKEND_LDFLAGS += -lwebsockets -pthread
